...
def main(client,re,AiD,dev_channel):
    ...
    def get_answer(question=""):
        if question=="":
            embed=discord.Embed(title="Oops",description="You need to enter a question",color=discord.Color(value=re[8]))
    ...
    def get_answer1(question=""):
        if question=="":
            ...
            file.write(a)
            file.close()
            embed=discord.Embed(title="Wolfram",description="This result is from Wolfram",color=discord.Color(value=re[8]))
            embed.set_thumbnail(url="https://www.wolfram.com/homepage/img/carousel-wolfram-alpha.png")
