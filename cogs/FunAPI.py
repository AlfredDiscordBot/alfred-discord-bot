...
class FunAPI(commands.Cog):
    ...
    async def latest(self, ctx):
        ...
        embed.add_field(
            name="Youtube", value=f"[Link]({self.space.youtube})", inline=True
        )
        embed.add_field(
            name="Wikipedia", value=f"[Link]({self.space.wikipedia})", inline=True
        )
    ...
    @nextcord.slash_command(
        name="dictionary", description="Use the dictionary for meaning"
    )
