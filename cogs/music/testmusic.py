...
class Music(commands.Cog, wavelink.WavelinkMixin):
    ...
    @commands.command(name="connect2")
    ...
    @commands.command(name="disconnect2")
    ...
    @commands.command(name="previous2")
